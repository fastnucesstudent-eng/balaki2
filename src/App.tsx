...
const LoadingOverlay = () => (
    <div className="fixed inset-0 z-[150] bg-background/80 backdrop-blur-xl flex flex-col items-center justify-center gap-6">
        ...
        <div className="flex flex-col items-center gap-1">
            <h2 className="text-xl font-black uppercase italic tracking-tighter opacity-50">Loading Balaki Organic</h2>
...
function App() {
    ...
    useEffect(() => {
        ...
        const handleHashChange = async () => {
            ...
            if (['#used', '#sale', '#catalog', '#categories'].some(h => hash.startsWith(h))) {
    ...
    useEffect(() => {
        if (searchQuery.trim() !== '') {
            const isFullPage = showAdmin || showCheckout || showProfile || viewProductId || showTrackOrder || showRateProduct;
            if (!isFullPage) {
    ...
    }, [searchQuery, showAdmin, showCheckout, showProfile, viewProductId, showTrackOrder, showRateProduct]);
