...
export const ProductForm = ({ productId, onClose, onSuccess }: ProductFormProps) => {
    ...
    useEffect(() => {
        ...
        setFormData(prev => {
            ...
            // Only update if current value matches the last auto-generated value OR is empty
            // This ensures that as long as the user hasn't manually diverged, it keeps syncing
            if (!prev.seo_title || prev.seo_title === lastAutoGeneratedRef.current.seo_title) {
                updates.seo_title = autoSeoTitle;
            }
            if (!prev.meta_description || prev.meta_description === lastAutoGeneratedRef.current.meta_description) {
                updates.meta_description = autoMetaDesc;
            }
            if (!prev.alt_text || prev.alt_text === lastAutoGeneratedRef.current.alt_text) {
