                            ...
                            <div className="flex flex-col sm:flex-row items-center gap-4">
                                ...
                                <div className="flex items-center gap-2 w-full sm:w-auto">
                                    {product.merchant_contact && (
                                        <a
                                            href={`https://wa.me/${product.merchant_contact.replace(/\D/g, '')}?text=${encodeURIComponent(`Hi! I'm interested in "${product.name}" (${import.meta.env.VITE_SITE_URL || window.location.origin}/#${generateProductURL(product.name, product.sku)}). Can you provide more details?`)}`}
                                            target="_blank"
